...
class MenuScraper {
    ...
    async getMensaMenu(mensa) {
        ...
        try {
            ...
            return new Promise.reject(new Error('Fail to get Studierendenwerk page.'));
        }
    }
    /**
    ...
    hasMenu(htmlPage) {
        ...
        const menuDivElement = document.querySelector('div[style*="border-radius: 4px 4px 0px 0px;"]');
    ...
    parseMenuHTML(htmlPage) {
      ...
      Array.from(details).forEach((item) => {
        ...
        const menuDivElement = window.document.querySelector('div[style*="border-radius: 4px 4px 0px 0px;"]');
